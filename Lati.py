...
if not st.session_state.authenticated:
    ...
    # Lakkoofsa barattootaa Cover page irratti akka mul'atuuf (Utuu hin login-inis ni argama)
    st.write("---")
    ...
    # YEROO LOG IN TA'AN QOFA NAVIGATION FI DASHBOARD-WWAN BANNAMU:
