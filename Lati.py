...
@@ -547,15 +9,15 @@ def pct_str(actual, target):
...
@@ -615,6 +77,11 @@ def pct_str(actual, target):
        st.markdown("---")
...
@@ -624,6 +91,7 @@ def pct_str(actual, target):
...
@@ -661,7 +129,7 @@ def pct_str(actual, target):
...
@@ -718,9 +186,21 @@ def validate_phone(phone_str, field_label):
...
@@ -729,590 +209,3 @@ def validate_phone(phone_str, field_label):
